...
public class DFS {
	...
	public DFS(File in, Graph gr) {
		...
		// Calls the method that will run depthFirstSearch method
		depthFirstSearch();
	...
	/**
	 * Calls dfs method and print method
	 */
	...
	/**
	 * DFS Method
	 * Starting from "s" node we will convert all nodes to white
	 * Perform a dfs and sort 
	 */
	public void dfs() {
		Node start = null;
	...
	/**
	 * DFS Visit Method 
	 * Determines discover and finish time of nodes
	 * Determines if node type Tree or Forward
	 * @param Node u
	 */
	...
	/**
	 * Determines if Node type is cross and back edges
	 */
	public void type() {
